# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 16:05:01 2019
...
def run_EV_simulation():
    ...
    Power_Supply = 198 #power threshold of the transformer/feeder for EV chagring
    charging_Pool = []
    ...
    #        for t in range(0,2): # how many requests to generate per step
        if (j%1 ==0): # the number controls how frequent a new charging request is generated
            for throughput in range(0,2): #throughput control
                n = n + 1
